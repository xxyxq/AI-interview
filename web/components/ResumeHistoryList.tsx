...
function ResumeHistoryItem({ result, isActive, onSelect, onDelete }: ResumeHistoryItemProps) {
    ...
    const subtitle = result.job_description
        ...
        : new Date(result.created_at).toLocaleTimeString('zh-CN', { hour: '2-digit', minute: '2-digit' });
    ...
    return (
        ...
        >
            ...
            <Icon className={cn(
                ...
                result.result_type === 'analyze' ? "text-teal-600" : "text-blue-600"
            )} />
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="text-[10px] text-gray-400 truncate" title={result.job_description || ''}>
                    {subtitle}
                </div>
            </div>
